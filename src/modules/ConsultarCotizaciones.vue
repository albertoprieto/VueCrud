<template>
  <div class="consultar-cotizaciones">
    ...
    <Dialog
      v-model:visible="editarDialogVisible"
      header="Editar Cotización"
      :modal="true"
      :closable="false"
      class="editar-cotizacion-dialog"
      :style="{ width: '70vw', maxWidth: '900px' }"
      :breakpoints="{ '1200px': '80vw', '960px': '90vw', '640px': '98vw' }"
    >
  ...
  <h4>Artículos</h4>
  <DataTable :value="selectedCotizacion.articulos" class="mb-2" responsiveLayout="scroll">
...
/* Editar Cotización dialog layout */
.editar-cotizacion-dialog :deep(.p-dialog-content) {
...
/* Ensure the DataTable can scroll horizontally on small screens */
.editar-cotizacion-dialog :deep(.p-datatable-wrapper) {
  overflow-x: auto;
}
