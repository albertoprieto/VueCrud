<template>
  <div class="recientes-container">
    <h2 class="recientes-title page-title">Renovaciones Recientes</h2>
    ...
    <div v-if="dataEnriquecida.length" class="stats-section">
      ...
      <div class="resultado-info">
        ...
        <div class="info-card-mini desconocido" :class="{ 'filtro-activo': filtroCard === 'desconocido' }" @click="toggleFiltroCard('desconocido')">
          <div class="card-icon">
        ...
        <div class="info-card-mini no-encontrado" :class="{ 'filtro-activo': filtroCard === 'noEncontrado' }" @click="toggleFiltroCard('noEncontrado')">
          <div class="card-icon">
    ...
    >
      <div style="padding: 0.25rem 0;">
        ...
        <div v-if="vincularDialog.sugerencias.length" style="margin-bottom:1rem;">
          ...
          >
            <i class="pi pi-file" style="color:var(--color-primary);"></i>
...
const FILTROS_CARD = {
  ...
  sinReporte: d => !d._tieneReporte && !['es_envio', 'no_requiere', 'desconocido', 'no_encontrado'].includes(d._status),
  esEnvio: d => d._status === 'es_envio',
  noRequiere: d => d._status === 'no_requiere',
  desconocido: d => d._status === 'desconocido',
  noEncontrado: d => d._status === 'no_encontrado',
};
...
const marcarStatus = async (rowData, nuevoStatus) => {
  try {
    ...
    await actualizarStatusRenovacionPorDispositivo(cuenta, numeroDispositivo, nuevoStatus);
